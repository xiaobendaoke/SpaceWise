...
<p align="center">
  <img src="docs/Screenshot_20260130_130112.png" height="500" alt="首页概览" />
</p>
...
> <img src="docs/Screenshot_20260130_130151.png" height="360" align="right" />

- **场所（Locations）**：支持多个空间（如我的家、父母家、办公室）。内置丰富模板，一键快速开始。
...
> <img src="docs/Screenshot_20260130_130227.png" height="360" align="right" />

- **拍照识别**：集成 Google ML Kit OCR，拍照自动识别物品名称，告别繁琐打字。
- **照片存储**：每个物品可附带照片，一目了然，不再靠名字猜物品。
- **属性管理**：支持过期日期、库存数量、自定义标签等多维度管理。
<br clear="all" />

#### 🔍 强大的搜索与定位

> <img src="docs/Screenshot_20260130_130213.png" height="360" align="right" />
...
> <img src="docs/Screenshot_20260130_130257.png" height="360" align="right" />
...
- **深色模式**：护眼舒适的夜间主题
- **流畅动画**：原生 Jetpack Compose 打造丝滑体验
- **离线优先**：无需网络，所有数据本地存储
